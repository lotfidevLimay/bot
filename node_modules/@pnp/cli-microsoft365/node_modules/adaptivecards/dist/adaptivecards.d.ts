...
declare module 'adaptivecards/card-elements' {
	...
	import { CardObjectRegistry, ElementSingletonBehavior } from 'adaptivecards/registry';
	...
	export class Container extends ContainerBase {
	    ...
	    protected undoOverflowTruncation(): void;
	    protected getHasBackground(ignoreBackgroundImages?: boolean): boolean;
	    protected canHostSingletons(): boolean;
	    protected internalParse(source: any, context: SerializationContext): void;
	    protected internalToJSON(target: PropertyBag, context: SerializationContext): void;
	    protected get isSelectable(): boolean;
	    getEffectivePadding(): PaddingDefinition;
	...
	export class SerializationContext extends BaseSerializationContext {
	    ...
	    parseCardObject<T extends CardObject>(parent: CardElement | undefined, source: any, forbiddenTypeNames: string[], allowFallback: boolean, createInstanceCallback: (typeName: string) => T | undefined, logParseEvent: (typeName: string, errorType: Enums.TypeErrorType) => void, parsingSingletonObject?: boolean): T | undefined;
	    parseElement(parent: CardElement | undefined, source: any, forbiddenTypes: string[], allowFallback: boolean, _parsingSingletonObject?: boolean): CardElement | undefined;
