...
class SpoThemeApplyCommand extends SpoCommand_1.default {
    constructor() {
        super();
    ...
    get name() {
        return commands_1.default.THEME_APPLY;
    }
    get description() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!isSharePointTheme) {
                    res = yield spo_1.spo.getRequestDigest(spoAdminUrl);
                }
                if (this.verbose) {
                ...
                if (isSharePointTheme) {
                    ...
                    requestOptions = {
                        ...
                        data: `<Request AddExpandoFieldTypeSuffix="true" SchemaVersion="15.0.0.0" LibraryVersion="16.0.0.0" ApplicationName="${config_1.default.applicationName}" xmlns="http://schemas.microsoft.com/sharepoint/clientquery/2009"><Actions><ObjectPath Id="10" ObjectPathId="9" /><Method Name="SetWebTheme" Id="11" ObjectPathId="9"><Parameters><Parameter Type="String">${formatting_1.formatting.escapeXml(args.options.name)}</Parameter><Parameter Type="String">${formatting_1.formatting.escapeXml(args.options.webUrl)}</Parameter></Parameters></Method></Actions><ObjectPaths><Constructor Id="9" TypeId="{268004ae-ef6b-4e9b-8425-127220d84719}" /></ObjectPaths></Request>`
                    };
                }
