...
class SpoGroupUserAddCommand extends SpoCommand_1.default {
    constructor() {
        super();
        _SpoGroupUserAddCommand_instances.add(this);
...
_SpoGroupUserAddCommand_instances = new WeakSet(), _SpoGroupUserAddCommand_initTelemetry = function _SpoGroupUserAddCommand_initTelemetry() {
...
}, _SpoGroupUserAddCommand_initOptions = function _SpoGroupUserAddCommand_initOptions() {
...
}, _SpoGroupUserAddCommand_initValidators = function _SpoGroupUserAddCommand_initValidators() {
