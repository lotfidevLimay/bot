...
exports.FN011011_MAN_webpart_supportedHosts = void 0;
const ManifestRule_1 = require("./ManifestRule");
class FN011011_MAN_webpart_supportedHosts extends ManifestRule_1.ManifestRule {
    constructor(add) {
        super();
        this.add = add;
    }
...
exports.FN011011_MAN_webpart_supportedHosts = FN011011_MAN_webpart_supportedHosts;
