...
exports.FN021010_PKG_gulp_installed_as_devdep = void 0;
const JsonRule_1 = require("../../JsonRule");
class FN021010_PKG_gulp_installed_as_devdep extends JsonRule_1.JsonRule {
    get id() {
        return 'FN021010';
    }
    get title() {
...
exports.FN021010_PKG_gulp_installed_as_devdep = FN021010_PKG_gulp_installed_as_devdep;
