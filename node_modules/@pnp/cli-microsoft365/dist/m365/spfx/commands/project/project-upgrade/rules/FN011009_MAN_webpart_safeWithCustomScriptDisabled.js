...
exports.FN011009_MAN_webpart_safeWithCustomScriptDisabled = void 0;
const ManifestRule_1 = require("./ManifestRule");
class FN011009_MAN_webpart_safeWithCustomScriptDisabled extends ManifestRule_1.ManifestRule {
    constructor(add) {
        super();
        this.add = add;
    }
...
exports.FN011009_MAN_webpart_safeWithCustomScriptDisabled = FN011009_MAN_webpart_safeWithCustomScriptDisabled;
