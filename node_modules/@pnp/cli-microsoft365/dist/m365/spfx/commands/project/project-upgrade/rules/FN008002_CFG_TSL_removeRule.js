...
exports.FN008002_CFG_TSL_removeRule = void 0;
const JsonRule_1 = require("../../JsonRule");
class FN008002_CFG_TSL_removeRule extends JsonRule_1.JsonRule {
    constructor(rule) {
        super();
        this.rule = rule;
    }
...
exports.FN008002_CFG_TSL_removeRule = FN008002_CFG_TSL_removeRule;
