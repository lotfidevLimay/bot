...
exports.FN012019_TSC_types_es6_promise = void 0;
const JsonRule_1 = require("../../JsonRule");
class FN012019_TSC_types_es6_promise extends JsonRule_1.JsonRule {
    constructor(add) {
        super();
        this.add = add;
    }
...
exports.FN012019_TSC_types_es6_promise = FN012019_TSC_types_es6_promise;
