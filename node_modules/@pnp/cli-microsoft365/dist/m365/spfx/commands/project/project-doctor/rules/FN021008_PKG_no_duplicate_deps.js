...
exports.FN021008_PKG_no_duplicate_deps = void 0;
const JsonRule_1 = require("../../JsonRule");
const spfxDeps = require("../spfx-deps");
class FN021008_PKG_no_duplicate_deps extends JsonRule_1.JsonRule {
    get id() {
        return 'FN021008';
    }
    get title() {
...
exports.FN021008_PKG_no_duplicate_deps = FN021008_PKG_no_duplicate_deps;
