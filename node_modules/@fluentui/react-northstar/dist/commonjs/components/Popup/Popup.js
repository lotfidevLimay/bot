...
function getRealEventProps(element) {
  if (element.type === _reactComponentRef.Ref || element.type === _reactComponentRef.RefFindNode || element.type === _reactComponentRef.RefForward) {
...
var Popup = function Popup(props) {
  ...
  var shouldBlurClose = function shouldBlurClose(e) {
    ...
    var isInsideTarget = (0, _domUtilities.elementContains)(e.currentTarget, relatedTarget); // When clicking in the popup content that has no tabIndex focus goes to body
