...
var usePortalBox = function usePortalBox(options) {
  ...
  var element = React.useMemo(function () {
    var newElement = (0, _isBrowser.isBrowser)() && target ? target.createElement('div') : null; // Element should be attached to DOM during render to make elements that will be rendered
