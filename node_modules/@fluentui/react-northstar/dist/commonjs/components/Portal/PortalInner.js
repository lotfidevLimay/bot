...
var _portalContext = require("../Provider/portalContext");
...
var PortalInner = function PortalInner(props) {
  ...
  var _React$useContext = React.useContext(_portalContext.PortalContext),
  ...
  var box = (0, _usePortalBox.usePortalBox)({
    className: className,
    target: target,
    rtl: rtl
  ...
  var container = (0, _utils.isBrowser)() ? mountNode || box || document.body : null;
