...
var extraConformanceTests_1 = require("./extraConformanceTests");
/**
...
function isConformant(Component, options) {
    ...
    var defaultConfig = {
        ...
        extraTests: extraConformanceTests_1.extraConformanceTests,
    };
    ...
    var helperComponentNames = __spreadArray([react_component_ref_1.Ref, react_component_ref_1.RefFindNode, react_component_ref_1.RefForward], (wrapperComponent ? [wrapperComponent] : [])).map(utils_1.getDisplayName);
        ...
        describe('"as" prop (common)', function () {
            test('renders the component as HTML tags or passes "as" to the next component', function () {
                ...
                tags.forEach(function (tag) {
                    var wrapper = utils_1.mountWithProvider(React.createElement(Component, __assign({}, requiredProps, { as: tag })));
            ...
            if (skipAsPropTests !== 'as-component') {
                test('renders as a functional component or passes "as" to the next component', function () {
                    var MyComponent = React.forwardRef(function () { return null; });
                    var wrapper = utils_1.mountWithProvider(React.createElement(Component, __assign({}, requiredProps, { as: MyComponent })));
                    var component = getComponent(wrapper);
                    try {
            ...
            test('passes extra props to the component it is renders as', function () {
                if (targetComponent) {
                    var el = utils_1.mountWithProvider(React.createElement(Component, __assign({}, requiredProps, { "data-extra-prop": "foo" }))).find(targetComponent);
                    expect(el.prop('data-extra-prop')).toBe('foo');
                }
                else {
                    var MyComponent = React.forwardRef(function () { return null; });
                    var el = utils_1.mountWithProvider(React.createElement(Component, __assign({}, requiredProps, { as: MyComponent, "data-extra-prop": "foo" }))).find(MyComponent);
                    expect(el.prop('data-extra-prop')).toBe('foo');
                }
            });
        });
