...
var portalContext_1 = require("src/components/Provider/portalContext");
...
describe('Provider', function () {
    ...
    describe('as', function () {
        it('allows to render a "React.Fragment"', function () {
            var wrapper = enzyme_1.mount(React.createElement(Provider_1.Provider, { as: React.Fragment },
                React.createElement("div", { id: "foo" })));
            expect(wrapper.html()).toMatchInlineSnapshot("\"<div id=\\\"foo\\\"></div>\"");
        });
        it('does not render "PortalContext.Provider" when is a "React.Fragment"', function () {
            var wrapper = enzyme_1.shallow(React.createElement(Provider_1.Provider, { as: React.Fragment },
                React.createElement("div", { id: "foo" })));
            expect(wrapper.find(portalContext_1.PortalContext.Provider).exists()).toBe(false);
        });
    });
