...
describe('Dropdown', function () {
    ...
    describe('open', function () {
        ...
        it('when set to "true" by trigger button click will move focus to the items list', function () {
            ...
            var _b = test_utils_2.renderDropdown(undefined, testContainer), clickOnTriggerButton = _b.clickOnTriggerButton, itemsListNode = _b.itemsListNode;
            clickOnTriggerButton();
    ...
    describe('getA11ySelectionMessage', function () {
        ...
        it('has items count narration element associated via aria-describedby after an item has been selected', function () {
            var itemToBeClickedIndex = 1;
            var _a = test_utils_2.renderDropdown({
                defaultOpen: true,
                getA11ySelectionMessage: { itemsCount: function (count) { return count + " item is  selected."; } },
                search: true,
                multiple: true,
            }), clickOnItemAtIndex = _a.clickOnItemAtIndex, searchInputNode = _a.searchInputNode, getItemsCountNode = _a.getItemsCountNode;
            clickOnItemAtIndex(itemToBeClickedIndex);
            var itemsCountNode = getItemsCountNode();
            var itemsCountNodeId = itemsCountNode.getAttribute('id');
    ...
    describe('activeSelectedIndex', function () {
        it('is set on active item click', function () {
            var _a = utils_1.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var _b = test_utils_2.renderDropdown({
                multiple: true,
                value: [test_utils_2.items[2]],
            }, testContainer), getSelectedItemNodeAtIndex = _b.getSelectedItemNodeAtIndex, clickOnSelectedItemAtIndex = _b.clickOnSelectedItemAtIndex;
        ...
        it('is set as last index on left arrow from the search query', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                ...
                search: true,
            }, testContainer), getSelectedItemNodeAtIndex = _b.getSelectedItemNodeAtIndex, keyDownOnSearchInput = _b.keyDownOnSearchInput;
        ...
        it('is set as last index on left arrow from the trigger button', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                multiple: true,
                value: [test_utils_2.items[0], test_utils_2.items[1], test_utils_2.items[2]],
            }, testContainer), getSelectedItemNodeAtIndex = _b.getSelectedItemNodeAtIndex, keyDownOnTriggerButton = _b.keyDownOnTriggerButton;
        ...
        it('is updated on arrow navigation after being set by click', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                multiple: true,
                value: [test_utils_2.items[0], test_utils_2.items[1], test_utils_2.items[2]],
            }, testContainer), getSelectedItemNodeAtIndex = _b.getSelectedItemNodeAtIndex, keyDownOnSelectedItemAtIndex = _b.keyDownOnSelectedItemAtIndex, clickOnSelectedItemAtIndex = _b.clickOnSelectedItemAtIndex;
        ...
        it('gets unset on right arrow from the last selected item and moves focus to trigger button', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                multiple: true,
                value: [test_utils_2.items[0], test_utils_2.items[1], test_utils_2.items[2]],
            }, testContainer), triggerButtonNode = _b.triggerButtonNode, keyDownOnSelectedItemAtIndex = _b.keyDownOnSelectedItemAtIndex, clickOnSelectedItemAtIndex = _b.clickOnSelectedItemAtIndex;
            clickOnSelectedItemAtIndex(2);
        ...
        it('gets unset on right arrow from the last selected item and moves focus to search input', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                ...
                value: [test_utils_2.items[0], test_utils_2.items[1], test_utils_2.items[2]],
                search: true,
            }, testContainer), searchInputNode = _b.searchInputNode, keyDownOnSelectedItemAtIndex = _b.keyDownOnSelectedItemAtIndex, clickOnSelectedItemAtIndex = _b.clickOnSelectedItemAtIndex;
            clickOnSelectedItemAtIndex(2);
            keyDownOnSelectedItemAtIndex(2, 'ArrowRight');
    ...
    describe('toggleIndicatorNode', function () {
        it('moves focus to list at click', function () {
            var _a = utils_1.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var _b = test_utils_2.renderDropdown(undefined, testContainer), clickOnToggleIndicator = _b.clickOnToggleIndicator, itemsListNode = _b.itemsListNode;
            clickOnToggleIndicator();
            expect(itemsListNode).toHaveFocus();
            removeTestContainer();
        });
        it('moves focus to input in search mode', function () {
            var _a = utils_1.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var _b = test_utils_2.renderDropdown({ search: true }, testContainer), clickOnToggleIndicator = _b.clickOnToggleIndicator, searchInputNode = _b.searchInputNode;
            clickOnToggleIndicator();
            expect(searchInputNode).toHaveFocus();
            removeTestContainer();
        });
    ...
    describe('disabled', function () {
        it('allows no action on the trigger button', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                disabled: true,
            }, testContainer), clickOnTriggerButton = _b.clickOnTriggerButton, focusTriggerButton = _b.focusTriggerButton, getItemNodes = _b.getItemNodes, triggerButtonNode = _b.triggerButtonNode, keyDownOnTriggerButton = _b.keyDownOnTriggerButton;
        ...
        it('allows no action on the search input', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                disabled: true,
                search: true,
            }, testContainer), keyDownOnSearchInput = _b.keyDownOnSearchInput, clickOnSearchInput = _b.clickOnSearchInput, focusSearchInput = _b.focusSearchInput, getItemNodes = _b.getItemNodes, searchInputNode = _b.searchInputNode;
        ...
        it('allows no action on the toggle indicator', function () {
            ...
            var _b = test_utils_2.renderDropdown({
                disabled: true,
            }, testContainer), clickOnToggleIndicator = _b.clickOnToggleIndicator, toggleIndicatorNode = _b.toggleIndicatorNode, getItemNodes = _b.getItemNodes;
            clickOnToggleIndicator();
            expect(getItemNodes()).toHaveLength(0);
    ...
    describe('accessibility trigger button aria labels', function () {
        it('trigger button should not have aria-label', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items }).triggerButtonNode;
            expect(triggerButtonNode).not.toHaveAttribute('aria-label');
        });
        it('trigger button should not have aria-labelledby', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items }).triggerButtonNode;
            expect(triggerButtonNode).not.toHaveAttribute('aria-labelledby');
        });
        it('trigger button should have aria-labelledby from user prop', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items, 'aria-labelledby': 'form-label' }).triggerButtonNode;
            expect(triggerButtonNode).toHaveAttribute('aria-labelledby', 'form-label');
        });
        it('trigger button should not have aria-describedby', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items }).triggerButtonNode;
