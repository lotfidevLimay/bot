...
exports.items = items;
var renderDropdown = function (props, attachTo) {
    if (props === void 0) { props = {}; }
    var wrapper = utils_1.mountWithProvider(React.createElement(Dropdown_1.Dropdown, __assign({ items: items }, props)), { attachTo: attachTo });
    ...
    var getItemsCountWrapper = function () { return utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.dropdownSlotClassNames.itemsCount); };
    ...
    return {
        ...
        getItemsCountNode: function () { return getItemsCountWrapper().getDOMNode(); },
        ...
        keyDownOnSearchInput: function (key, optional) {
            return searchInputWrapper.simulate('keydown', __assign({ key: key }, optional));
        },
        keyDownOnItemsList: function (key, optional) { return itemsListWrapper.simulate('keydown', __assign({ key: key }, optional)); },
        keyDownOnTriggerButton: function (key, optional) {
            return triggerButtonWrapper.simulate('keydown', __assign({ key: key }, optional));
        },
        keyDownOnSelectedItemAtIndex: function (index, key, optional) {
            getSelectedItemWrapperAtIndex(index).simulate('keydown', __assign({ key: key }, optional));
        },
