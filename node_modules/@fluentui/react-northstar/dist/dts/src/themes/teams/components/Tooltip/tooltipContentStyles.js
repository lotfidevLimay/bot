...
exports.tooltipContentStyles = {
    ...
    content: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign({ display: 'block', fontSize: utils_1.pxToRem(12), padding: v.padding, textAlign: 'left', color: v.color, background: v.backgroundColor, borderRadius: v.borderRadius, boxShadow: v.boxShadow }, (p.subtle && {
