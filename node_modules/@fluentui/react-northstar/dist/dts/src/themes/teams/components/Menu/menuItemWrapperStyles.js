...
exports.menuItemWrapperStyles = {
    root: function (_a) {
        ...
        return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({ color: 'inherit', lineHeight: 1, position: 'relative', verticalAlign: 'middle', display: 'block' }, (secondary && {
            background: 'salmon',
        })), (vertical && {
            ...
            !vertical && __assign(__assign(__assign(__assign(__assign({ color: v.wrapperColorActive }, (!underlined && {
