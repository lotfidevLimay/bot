...
exports.menuColorAreas = utils_1.stringLiteralsArray('border', 'borderActive', 'foregroundActive', 'foregroundFocus', 'foregroundHover', 'backgroundHover', 'backgroundActive', 'backgroundFocus', 'foregroundDisabled');
var menuVariables = function (siteVars) {
    return {
        ...
        horizontalPadding: utils_1.pxToRem(14) + " " + utils_1.pxToRem(18),
        verticalBackgroundColor: siteVars.colorScheme.default.background,
        verticalItemPadding: utils_1.pxToRem(7) + " " + utils_1.pxToRem(12),
        verticalBoxShadow: siteVars.shadow16,
        verticalDividerMargin: utils_1.pxToRem(8) + " 0",
        verticalItemBorderWidth: utils_1.pxToRem(2),
        ...
        underlinedBottomBorderWidth: utils_1.pxToRem(2),
        ...
        dividerHeight: utils_1.pxToRem(1),
        borderWidth: utils_1.pxToRem(1),
