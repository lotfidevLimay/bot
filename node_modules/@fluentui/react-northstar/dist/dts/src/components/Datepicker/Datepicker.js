...
exports.Datepicker = React.forwardRef(function (props, ref) {
    ...
    var calendarElement = utils_1.createShorthand(DatepickerCalendar_1.DatepickerCalendar, calendar, {
        defaultProps: function () { return getA11yProps('calendar', __assign(__assign({}, calendarOptions), dateFormatting)); },
    ...
    var overrideInputProps = function (predefinedProps) { return ({
        ...
        onChange: function (e, target) {
            ...
            if (!!validationError) {
                _.invoke(props, 'onDateChangeError', e, __assign(__assign({}, props), { error: validationError }));
            }
            else {
                setSelectedDate(parsedDate);
                _.invoke(props, 'onDateChange', e, __assign(__assign({}, props), { value: parsedDate }));
            }
    ...
    var element = getA11yProps.unstable_wrapWithFocusZone(React.createElement(ElementType, __assign({}, getA11yProps('root', __assign({ className: classes.root, ref: ref }, unhandledProps))),
        !props.buttonOnly &&
