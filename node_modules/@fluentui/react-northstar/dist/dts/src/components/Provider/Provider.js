...
var renderStaticStyles = function (renderer, theme, siteVariables) {
    ...
    theme.staticStyles.forEach(function (staticStyle) {
        if (typeof staticStyle === 'string') {
            ...
            var preparedSiteVariables = styles_1.mergeSiteVariables(undefined, siteVariables);
...
var Provider = function (props) {
    ...
    var classes = (rendersReactFragment
        ? { classes: { root: '' } }
        : react_bindings_1.unstable_getStyles({
    ...
    var portalContextValue = React.useMemo(function () { return ({ className: classes.root }); }, [classes.root]);
    ...
    if (rendersReactFragment) {
        return (React.createElement(RenderProvider, { target: outgoingContext.target },
            React.createElement(react_bindings_1.Unstable_FluentContextProvider, { value: outgoingContext },
                React.createElement(React.Fragment, null, children))));
    }
    return (React.createElement(RenderProvider, { target: outgoingContext.target },
        React.createElement(react_bindings_1.Unstable_FluentContextProvider, { value: outgoingContext },
            React.createElement(portalContext_1.PortalContext.Provider, { value: portalContextValue },
                React.createElement(ElementType, __assign({ className: classes.root }, rtlProps, unhandledProps), children)))));
};
