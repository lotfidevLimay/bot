...
var Popup = function (props) {
    ...
    var renderPopperChildren = function (classes) { return function (_a) {
        ...
        return (React.createElement(react_component_nesting_registry_1.Unstable_NestingAuto, null, function (getRefs, nestingRef) { return (React.createElement(React.Fragment, null,
            ...
            context.target && (React.createElement(React.Fragment, null,
                ...
                (isOpenedByRightClick || closeOnScroll) && (React.createElement(React.Fragment, null,
    ...
    var dismissOnScroll = function (e) {
        ...
        if (!dom_utilities_1.elementContains(popupContentRef.current, e.target)) {
            trySetOpen(false, e);
        }
    };
...
exports.Popup.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    ...
    ]), open: PropTypes.bool, onOpenChange: PropTypes.func, pointing: PropTypes.bool, position: PropTypes.oneOf(positioner_1.POSITIONS), positionFixed: PropTypes.bool, renderContent: PropTypes.func, target: PropTypes.any, trigger: customPropTypes.every([customPropTypes.disallow(['children']), PropTypes.any]), tabbableTrigger: PropTypes.bool, unstable_disableTether: PropTypes.oneOf([true, false, 'all']), unstable_pinned: PropTypes.bool, autoSize: PropTypes.oneOf(positioner_1.AUTOSIZES), content: customPropTypes.shorthandAllowingChildren, contentRef: customPropTypes.ref, trapFocus: PropTypes.oneOfType([PropTypes.bool, PropTypes.object]), autoFocus: PropTypes.oneOfType([PropTypes.bool, PropTypes.object]), closeOnScroll: PropTypes.bool });
