...
exports.dropdownSlotClassNames = {
    ...
    itemsCount: exports.dropdownClassName + "__items-count",
...
exports.Dropdown = React.forwardRef(function (props, ref) {
    ...
    var selectedItemsCountNarrationId = React.useMemo(function () { return _.uniqueId('dropdown-selected-items-count-'); }, []);
    ...
    var popperRef = react_bindings_1.useMergedRefs(props.popperRef);
    React.useLayoutEffect(function () {
        var _a;
        (_a = popperRef.current) === null || _a === void 0 ? void 0 : _a.updatePosition();
    }, [filteredItems === null || filteredItems === void 0 ? void 0 : filteredItems.length, popperRef]);
    ...
    var renderTriggerButton = function (getToggleButtonProps) {
        ...
        var triggerButtonProps = getToggleButtonProps(__assign(__assign({ disabled: disabled, onFocus: handleTriggerButtonOrListFocus, onBlur: handleTriggerButtonBlur, onKeyDown: function (e) {
                handleTriggerButtonKeyDown(e);
            }, 'aria-invalid': ariaInvalid, 'aria-label': undefined }, (ariaLabelledby && { 'aria-labelledby': ariaLabelledby })), (open && { 'aria-expanded': true })));
    ...
    var renderSelectedItemsCountNarration = function (id) {
        ...
        return (React.createElement("span", { id: id, className: exports.dropdownSlotClassNames.itemsCount, style: accessibilityStyles_1.screenReaderContainerStyles }, narration));
    };
    ...
    var renderSelectedItems = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { role: "listbox", tabIndex: -1, "aria-label": a11ySelectedItemsMessage }, selectedItems),
