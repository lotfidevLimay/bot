...
exports.Attachment = exports.attachmentProgressBarClassName = exports.attachmentProgressContainerClassName = exports.attachmentClassName = void 0;
...
exports.attachmentProgressContainerClassName = exports.attachmentClassName + "__progress-container";
exports.attachmentProgressBarClassName = exports.attachmentClassName + "__progress";
/**
...
exports.Attachment = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    var element = getA11Props.unstable_wrapWithFocusZone(React.createElement(ElementType, __assign({}, getA11Props('root', __assign({ className: classes.root, onClick: handleClick, ref: ref }, unhandledProps))),
        ...
        !_.isNil(progress) && (React.createElement("div", { className: exports.attachmentProgressContainerClassName },
            React.createElement("div", { className: exports.attachmentProgressBarClassName, style: { width: progress + "%" } })))));
    setEnd();
    return element;
}, {
    className: exports.attachmentClassName,
...
exports.Attachment.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
