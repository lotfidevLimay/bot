...
describe('mergeComponentVariables', function () {
    ...
    function testMergeComponentVariables(mergeComponentVariables) {
        ...
        test('merged functions accept and apply siteVariables', function () {
            var target = function (siteVariables) { return (__assign({ one: 1, target: true }, siteVariables)); };
            var source = function (siteVariables) { return (__assign({ two: 2, source: true }, siteVariables)); };
            var merged = mergeComponentVariables(target, source);
    ...
    describe('dev version, debug enabled', function () {
        ...
        describe('debug frames', function () {
            test('are saved', function () {
                var target = function (siteVariables) { return (__assign({ one: 1, a: 'tA', target: true }, siteVariables)); };
                var source = function (siteVariables) { return (__assign({ two: 2, a: 'sA', source: true }, siteVariables)); };
